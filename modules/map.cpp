...
Map::Map(){
    ...
    if (!tileSet1Texture.loadFromFile("ressources/tileset1.png")){
        cout << "Erreur durant le chargement de l'image du tileset 1." << endl;
    }else
        tileSet1.setTexture(tileSet1Texture);
 
    if (!tileSet1BTexture.loadFromFile("ressources/tileset1b.png")){
...
void Map::changeLevel(void){ // Récupère le nom de la map pour la charger
    string filename;
